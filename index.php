...
<head>
    ...
    <link rel="stylesheet"
          href="../../../Downloads/Omnifood-After-Section-7/Omnifood - After Section 7/resources/css/queries.css">
...
<section class="cities" id="cities">
    ...
    <div class="row js--wp-3">
        <div class="col span-1-of-4 box">
            <img src="resources/img/lisbon-3.jpg" alt="Lisbon" class="city-screen">
            <h3>Lisbon</h3>
        ...
        <div class="col span-1-of-4 box">
            <img src="resources/img/san-francisco.jpg" alt="San Francisco" class="city-screen">
            <h3>San Francisco</h3>
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                3700+ happy eaters
        ...
        <div class="col span-1-of-4 box">
            <img src="resources/img/berlin.jpg" alt="Berlin" class="city-screen">
            <h3>Berlin</h3>
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                2300+ happy eaters
        ...
        <div class="col span-1-of-4 box">
            <img src="resources/img/london.jpg" alt="London" class="city-screen">
            <h3>London</h3>
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                1200+ happy eaters
    ...
    <div class="row">
        <div class="col span-1-of-3">
            <blockquote>
                ...
                <cite><img src="resources/img/kristoffer.jpg" class="testimonial-img js--wp-6">Kristoffer Jensen</cite>
            </blockquote>
        </div>
        <div class="col span-1-of-3">
            <blockquote>
                Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery
                here in Lisbon, but no one comes even close to Omnifood. Me and my family are so in love!
                <cite><img src="resources/img/michelle.jpg" class="testimonial-img js--wp-5">Michelle Tran</cite>
            </blockquote>
        </div>
        <div class="col span-1-of-3">
            <blockquote>
                ...
                <cite><img src="resources/img/customer-3.jpg" class="testimonial-img">Milton Chapman</cite>
            </blockquote>
        </div>
    </div>
</section>
